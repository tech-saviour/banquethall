...
const PhotoGallery = () => {
    ...
    return (
        <section className='px-6 py-12 md:px-36 bg-[#F8F1E9] text-gray-800'>
            <h2 className="text-4xl sm:text-6xl font-serif text-center mb-8">Photo Gallery</h2>
            <div className="grid grid-cols-4 grid-rows-3 gap-1 sm:gap-2">
                ...
                <motion.div
                    className="col-span-2 relative w-full h-24 sm:h-64 md:h-44 sparkle-effect"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
